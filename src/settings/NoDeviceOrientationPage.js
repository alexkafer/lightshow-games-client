...
const NoDeviceOrientationPage = () => {
  return (
    <div className="container center-item">
        ...
        <Button className='m-1' href={"googlechromes://" + window.location.host} variant="primary">Open in Chrome</Button>
        <Button className='m-1' href="itms-apps://itunes.apple.com/us/app/chrome/id535886823" variant="secondary">Install Chrome</Button>
        <p className='pt-5 lead'>Alternatively, you can enable device orientation in Settings > Safari > Motion & Orientation Access.</p>
      </div>
  )
}
